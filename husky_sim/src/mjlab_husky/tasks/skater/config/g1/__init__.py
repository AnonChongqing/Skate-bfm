...
from .env_cfgs import (
  unitree_g1_skater_env_cfg,
  unitree_g1_skater_slope_materials_env_cfg,
)
from .rl_cfg import unitree_g1_skater_ppo_runner_cfg
...
register_mjlab_task(
  task_id="Mjlab-Skater-SlopeMaterials-Unitree-G1",
  env_cfg=unitree_g1_skater_slope_materials_env_cfg(),
  play_env_cfg=unitree_g1_skater_slope_materials_env_cfg(play=True),
  rl_cfg=unitree_g1_skater_ppo_runner_cfg(),
  runner_cls=SkaterOnPolicyRunner,
)
